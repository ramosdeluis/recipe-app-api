...
class PublicUserApiTests(TestCase):
    ...
    def test_password_too_short_error(self):
        """Teste an error is returned if password less than 5 chars."""
        payload = {
            "email": "test@example.com",
            "password": "123",
            "name": "Test Name",
    ...
    def test_create_token_for_user(self):
        """Test generateds token for valid credentials."""

        user_details = {
            "name": "Test Name",
            "email": "test@example.com",
            "password": "test-password-user123",
        }
    ...
    def test_blank_password_credentials(self):
